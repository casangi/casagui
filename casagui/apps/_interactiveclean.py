...
class InteractiveClean:
    ...
    *Please see tclean documentation for details about the arguments summarized here.*
    ...
    def __init__( self, vis, imagename, mask=None, field='', spw='', timerange='', uvrange='', antenna='', scan='', observation='', intent='',
                  ...
                  start='', width='', outframe='LSRK', interpolation='linear', perchanweightdensity=True, gridder='standard', wprojplanes=int(1),
        ...
        self._clean = _gclean( vis=vis, imagename=imagename, field=field, spw=spw, timerange=timerange,  uvrange=uvrange, antenna=antenna, scan=scan,
                               ...
                               phasecenter=phasecenter, stokes=stokes, specmode=specmode, reffreq=reffreq, nchan=nchan, start=start, width=width,
                               outframe=outframe, interpolation=interpolation, perchanweightdensity=perchanweightdensity, gridder=gridder,
                               wprojplanes=wprojplanes, mosweight=mosweight, psterm=psterm, wbawp=wbawp, usepointing=usepointing, conjbeams=conjbeams,
                               pointingoffsetsigdev=pointingoffsetsigdev, pblimit=pblimit, deconvolver=deconvolver, niter=niter, threshold=threshold,
                               nsigma=nsigma, cycleniter=cycleniter, cyclefactor=cyclefactor, scales=scales, restoringbeam=restoringbeam, pbcor=pbcor,
                               ...
                               fastnoise=fastnoise, savemodel=savemodel, parallel=parallel, nmajor=nmajor, usemask=self._usemask, mask=self._mask_path
                      )
        ###

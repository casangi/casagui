...
class TipButton(AbstractButton):
    ...
    predisplay = Nullable(Instance(Callback), help='''
    predisplay callback is called with the tooltip prior to displaying the tooltip
    to allow for context sensitive tooltips.
    ''')
